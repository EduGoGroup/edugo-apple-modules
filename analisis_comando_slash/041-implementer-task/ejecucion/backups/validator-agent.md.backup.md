...
**Cambios**: Agregado tools: Bash al frontmatter, javascript como alias de nodejs, tech requerido, detección de configuración de proyecto, nota de extensibilidad
