...
public struct MaterialFilterContext: Sendable, Equatable {
    ...
    public let sortOrder: UseCases.SortOrder
    ...
    public init(
        ...
        sortOrder: UseCases.SortOrder = .descending
    ) {
    ...
    public init(from filters: MaterialFilters, sortBy: MaterialSortOption, sortOrder: UseCases.SortOrder) {
